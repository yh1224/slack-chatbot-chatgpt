...
type SlackChatbotChatgptStackProps = cdk.StackProps & {
  readonly config: Config;
}

export class SlackChatbotChatgptStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: SlackChatbotChatgptStackProps) {
